...
<template>
  ...
  <swiper :slides-per-view="1" :modules="modules" :autoplay="{ delay: 5000 }" :scrollbar="{ draggable: true }">
      <swiper-slide>
        <RouterLink :to="`/category/${RouteNames.MENS}`" class="swiper before:bg-mens">For Men</RouterLink>
      </swiper-slide>
      <swiper-slide>
        <RouterLink :to="`/category/${RouteNames.WOMENS}`" class="swiper before:bg-womens">For Women</RouterLink>
      </swiper-slide>
      <swiper-slide>
        <RouterLink :to="`/category/${RouteNames.JEWELLERY}`" class="swiper before:bg-jewellery">Jewellery</RouterLink>
      </swiper-slide>
      <swiper-slide>
        <RouterLink :to="`/category/${RouteNames.ELECTRONICS}`" class="swiper before:bg-electronics">Electronics
        </RouterLink>
      </swiper-slide>
    </swiper>
  </div>
